...
percentile_sinr = zeros( 3, ...
                       ...
                       length( blockageDensity_vector ), ...
                       length( bodyAttenuation_vector ) );
avg_spectralEff = zeros( length( apDensity_vector ), ...
                       length( beamWidth_vector ), ...
                       length( apHeight_vector ), ...
                       length( blockageDensity_vector ), ...
                       length( bodyAttenuation_vector ) );
lobeEdge_matrix = zeros( length( beamWidth_vector ), ...
                       length( apHeight_vector ) );
halfInterSiteDistance = zeros( size( apDensity_vector ) );
        ...
        for h_id = 1:length( apHeight_vector )
            ...
            for bw_id = 1:length( beamWidth_vector )
                ...
                for d_id = 1:length( apDensity_vector )
                    ...
                    [ apPosition, numberOfAps, interSiteDistance ] = ...
                        HexagonCellGrid( areaSide, apDensity );
                    halfInterSiteDistance( d_id ) = .5 * interSiteDistance;
