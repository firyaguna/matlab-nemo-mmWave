...
for db_id = 1:length( distanceToUserBody_vector )
    ...
    for ba_id = 1:length( bodyAttenuation_vector )
        ...
        if db_id == 2 && ba_id == 2 % skip
            sinr_vector( n_iter, bw_id, h_id, d_id, bl_id, ba_id, db_id ) = ...
                sinr_vector( n_iter, bw_id, h_id, d_id, bl_id, ba_id, 1 );
            avg_spectralEff( bw_id, h_id, d_id, bl_id, ba_id, db_id ) = ...
                avg_spectralEff( bw_id, h_id, d_id, bl_id, ba_id, 1 );
        else
